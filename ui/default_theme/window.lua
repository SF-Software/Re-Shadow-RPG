...
function window:draw(width, height)
	...
	drawborder(self.windowskin, v00, v00, vec(width - 16, 0), v10) --上
	drawborder(self.windowskin, v00, v00, vec(0, height - 16), v01) --左
	drawborder(self.windowskin, v30, vec(width - 16, 0), vec(width - 16, height - 16), v01) --右
	drawborder(self.windowskin, v03, vec(0, height - 16), vec(width - 16, height - 16), v10) --下
